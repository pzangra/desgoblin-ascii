...
# Add import for the noise generator
try:
    from noise import pnoise2
except ImportError:
    # Fallback to a simplified noise function if the noise library isn't available
...
class Map:
    ...
    def clear_screen(self):
        ...
        # Clear input buffer to prevent previous inputs from affecting new prompts
        # This uses a non-blocking approach to clear any pending input
        import sys
        import termios
        import tty
        import select
        ...
        try:
            ...
            # If modules aren't available, use this alternative approach
            try:
                ...
                # Last resort fallback - at least try to flush stdout
                sys.stdout.flush()
